module SpiffyStoresApp
  class ScripttagsManager
    ...
    def self.queue(shop_domain, shop_token)
      SpiffyStoresApp::ScripttagsManagerJob.perform_later(shop_domain: shop_domain, shop_token: shop_token)
    end
    ...
    def destroy_scripttags
      SpiffyStoresAPI::ScriptTag.all.each do |scripttag|
        SpiffyStoresAPI::ScriptTag.delete(scripttag.id) if is_required_scripttag?(scripttag)
      end
