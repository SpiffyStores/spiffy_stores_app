require 'test_helper'
require 'generators/spiffy_stores_app/app_proxy_controller/app_proxy_controller_generator'

class AppProxyControllerGeneratorTest < Rails::Generators::TestCase
  tests SpiffyStoresApp::Generators::AppProxyControllerGenerator
  ...
  test "adds app_proxy route to routes" do
    ...
    assert_file "config/routes.rb" do |routes|
      assert_match "mount SpiffyStoresApp::Engine, at: '/'\n", routes
